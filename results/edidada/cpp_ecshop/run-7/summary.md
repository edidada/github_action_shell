...
| Run | [#7](https://github.com/edidada/github_action_shell/actions/runs/36023225824) |
| 触发方式 | `workflow_dispatch` |
| 触发者 | `edidada` |
| Runner | `Linux-X64` |
| 完成时间 | 2026-09-24 15:51:47 UTC |
...
| ctest | ✅ ok | 0 | 0m02s | [04-ctest.log](logs/04-ctest.log) |
