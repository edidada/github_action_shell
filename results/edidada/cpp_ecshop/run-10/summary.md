...
| Run | [#10](https://github.com/edidada/github_action_shell/actions/runs/36110386438) |
| 触发方式 | `schedule` |
| 触发者 | `edidada` |
| Runner | `Linux-X64` |
| 完成时间 | 2026-09-25 08:03:06 UTC |
...
| cmake configure | ✅ ok | 0 | 3m54s | [02-cmake-configure.log](logs/02-cmake-configure.log) |
| cmake build | ✅ ok | 0 | 0m23s | [03-cmake-build.log](logs/03-cmake-build.log) |
| ctest | ✅ ok | 0 | 0m00s | [04-ctest.log](logs/04-ctest.log) |
...
- [02-cmake-configure.log](logs/02-cmake-configure.log) · 429 行
- [03-cmake-build.log](logs/03-cmake-build.log) · 44 行
- [04-ctest.log](logs/04-ctest.log) · 10 行
