...
| Run | [#8](https://github.com/edidada/github_action_shell/actions/runs/36023809244) |
| 触发方式 | `workflow_dispatch` |
| 触发者 | `edidada` |
| Runner | `Linux-X64` |
| 完成时间 | 2026-09-24 16:01:36 UTC |
...
| cmake configure | ✅ ok | 0 | 4m16s | [02-cmake-configure.log](logs/02-cmake-configure.log) |
