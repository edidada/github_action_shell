...
| Run | [#9](https://github.com/edidada/github_action_shell/actions/runs/36027893184) |
| 触发方式 | `workflow_dispatch` |
| 触发者 | `edidada` |
| Runner | `Linux-X64` |
| 完成时间 | 2026-09-24 16:36:10 UTC |
...
| cmake configure | ✅ ok | 0 | 4m10s | [02-cmake-configure.log](logs/02-cmake-configure.log) |
| cmake build | ✅ ok | 0 | 0m25s | [03-cmake-build.log](logs/03-cmake-build.log) |
